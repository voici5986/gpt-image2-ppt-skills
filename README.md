...
- 🎨 **十套精选风格 + 蒸馏风格库** — 内置 Spatial Glass / Tech Blue / Editorial Mono / Dark Aurora / Riso / Wabi / Swiss Grid / Hand Sketch / Y2K Chrome / Vector Illustration；另从 500+ 个在线 PPT 模板候选中蒸馏并筛选出 22 个可复用风格
...
## 🧬 蒸馏风格库：从 500+ 个 PPT 模板中筛出 22 个

我们搭了一条在线 PPT 模板蒸馏流程：抓取网络公开预览图，按视觉质量、版式系统、可复用性和复制风险打分，再用多模态模型抽取抽象风格规则，最后用 `gpt-image-2` 生成验证封面做对比。当前已从 500+ 个候选模板中筛出 22 个风格，并仍在持续蒸馏中；也欢迎大家提供好看的 PPT 模板或风格参考。
